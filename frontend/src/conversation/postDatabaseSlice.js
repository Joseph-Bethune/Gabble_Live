...
const sliceName = "postDatabaseSlice";
...
export const rootMessageSearchThunk = createAsyncThunk(
    ...
    },
    {
        condition: (_, { getState }) => {
            ...
            const thunkStatus = getState().postDatabaseSlice.thunkStatuses.rootSearch;
...
const postDatabaseSlice = createSlice({
    name: sliceName,
...
export const getRootPosts = (state) => state.postDatabaseSlice.rootPosts;
export const getPosts = (state) => state.postDatabaseSlice.posts;

// thunk statuses
export const getRootMessageSearchThunkStatus = (state) => state.postDatabaseSlice.thunkStatuses.rootSearch;
export const getIdMessageSearchThunkStatus = (state) => state.postDatabaseSlice.thunkStatuses.idSearch;
export const getChangeLikeStatusThunkStatus = (state) => state.postDatabaseSlice.thunkStatuses.changeLikeStatus;
export const getSendMessageThunkStatus = (state) => state.postDatabaseSlice.thunkStatuses.sendMessage;

export const getChangeTagsThunkStatus = (state) => state.postDatabaseSlice.thunkStatuses.changeTags.status;
export const getChangeTagsThunkStatusError = (state) => state.postDatabaseSlice.thunkStatuses.changeTags.error;
